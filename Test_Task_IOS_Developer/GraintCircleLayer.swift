//
//  GraintCircleLayer.swift
//  Test_Task_IOS_Developer
//
//  Created by Артем on 12/03/17.
...
class GraintCircleLayer: CALayer {
    ...
    func layerWithWithBounds(bounds:CGRect, position:CGPoint, fromColor:UIColor, toColor:UIColor, linewidth : CGFloat,toValue:CGFloat) -> GraintCircleLayer {
        let layer = GraintCircleLayer(bounds: bounds,position: position,fromColor:fromColor, toColor: toColor,linewidth: linewidth,toValue:toValue )
        return layer
    }
